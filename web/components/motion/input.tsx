  ...
  return (
    <div className={cn("flex flex-col gap-1.5", className, classNames?.root)}>
      ...
      <div
        ...
        className={cn(
          "relative h-9 overflow-hidden rounded-sm border transition-colors duration-200",
          "border-border",
      ...
      >
        ...
        <input
          ...
          className={cn(
            "peer h-full w-full bg-transparent text-sm leading-6 text-foreground caret-foreground outline-none",
        ...
        {success ? (
          <motion.svg
            ...
            fill="none"
            className={cn(
              "absolute right-3.5 top-1/2 h-5 w-5 -translate-y-1/2 text-can-use",
